  ...
  try {
    ...
    const prompt = type === 'fresher' 
      ? `Generate a professional summary for a fresh graduate/entry-level candidate with the following details:
         ...
         The summary should be 2-3 sentences highlighting their potential, education background, and career objectives. Make it ATS-friendly and professional. Return only the summary text without any additional formatting.`
      : `Generate an executive summary for an experienced professional with the following details:
         Name: ${personalDetails.fullName}
         Email: ${personalDetails.email || 'Not provided'}
         
         The summary should be 2-3 sentences highlighting their experience, expertise, and value proposition. Make it ATS-friendly and impactful. Return only the summary text without any additional formatting.`;
